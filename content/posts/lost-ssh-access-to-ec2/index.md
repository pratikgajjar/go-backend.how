...
draft = false
tags = ['aws', 'ec2', 'ssh']
images = ["og-93f1d193.png"]
hnItemId = 41270300
theme = "steel"
+++

{{< figure src="xiaohei-hero.png" alt="Xiaohei regaining SSH access to a locked EC2 box by adding its public key through user-data so cloud-init injects it on reboot" >}}
